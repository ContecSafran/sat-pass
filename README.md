...
내 위치에서 인공위성이 언제 하늘을 지나가는지 알려 주는 안드로이드 앱.

관심 있는 위성을 등록해 두면 앞으로 며칠간의 통과(패스) 일정을 시간순으로 보여 주고,
...
> 저장소가 비공개이므로 휴대폰 브라우저에서도 GitHub 에 로그인되어 있어야 받을 수 있습니다.
...
**스케줄** 탭에서 화면을 **아래로 당겼다 놓으면** 인터넷에서 활성 위성 전체(약 11,000개)의
TLE 를 받아옵니다. 몇 초 걸립니다.

### 2단계 — 관심 위성 추가

**위성** 탭에서 위성 이름이나 NORAD 번호로 검색합니다. (예: `NOAA 19`, `25544`)
